...
class ResultView: UIView {
  ...
  var restVC = ResultViewController()
  ...
  public let recalculateButton: UIButton = {
  ...
  override func layoutSubviews() {
    ...
    adviseImage.image = UIImage(named: restVC.image!)
//    backgroundColor = restVC.color
